...
public class LoginActivity extends AppCompatActivity {
    ...
    private CardView btnContinue,btnTakemein;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phone = findViewById(R.id.editPatientID);
        databaseReference = firebaseDatabase.getReference("users");
        data2 = firebaseDatabase.getReference("check");
                    ...
                    data2.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if(dataSnapshot.child(number).exists()){
                                ...
                                Toast.makeText(getApplicationContext(),"PATIENT DOESN'T EXISTS",Toast.LENGTH_LONG).show();
                            }
                        }
